...
const welcome: JSX.Element = (
    <>
        ...
        <p>
            My name is Chris Siddall, I am currently the fine age of 35 years old (1985), and are currently based in Tamworth Staffordshire.
            ...
            It is not my intention to sound overly professional or formal because I want this to be about expressing who I am.
        </p>
        <h1>About Me</h1>
        <p>I am a proud father to my 6 year old son and believe this has had a very positive effect on my outlook towards life.
            My father has helped mould me in to the person I am today so I am hoping to replicate that with my son.
        ...
        <p>Besides computer programming, I have been an obsessive carp fisherman since the age of 7 and lovingly fish in all weather conditions.
            ...
            Those days are behind me now but I am still very passionate about music due to it's wonderful natural mood altering effects.
            
            
            Nowdays I'm interested in politics .. family //sidtodo
        </p>

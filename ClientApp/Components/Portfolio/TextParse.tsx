...
export const TextParsePortfolio: React.SFC<ITextParsePortfolioProps> = (props) => {
    return (
        <PortfolioBase
            {...props}
            about={About()}
            aboutHeading="Text Parse Library"
...
const carouselImgs : ICarouselImg[] = [
    ...
    {
        src: "/img/textparse/consoleoutput1.jpg",
...
const About: any = () => {
    return (
        <>
            ...
            <h2>Theory</h2>
            <h3>User Created Parse Algorithms (UCPA)</h3>
            ...
            <h3>Outer Linear Parse Algorithm (OLPA)</h3>
            ...
            <h3>Programming Language/Platform</h3>
